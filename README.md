...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1543&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-rio-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-rio` can be installed with `conda`:
...
It is possible to list all of the versions of `r-rio` available on your platform with `conda`:
...
```
mamba search r-rio --channel conda-forge
```
...
mamba repoquery search r-rio --channel conda-forge

# List packages depending on `r-rio`:
mamba repoquery whoneeds r-rio --channel conda-forge

# List dependencies of `r-rio`:
mamba repoquery depends r-rio --channel conda-forge
```
